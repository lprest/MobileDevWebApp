...
namespace MobileDevWebApp.Models
{
    ...
    {
        private string connectionString = "Data Source=CS-01\\SQLEXPRESS;Integrated Security=True; Inital Catalog=Tea; Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False";
